      ...
      {loading ? (
        ...
        <div>
          {keywords.length === 0 ? (
            ...
            keywords.map((item) => (
              <div key={item._id} className="flex justify-between text-left items-center bg-gray-100 p-3 rounded-md mt-2">
                <div>
                ...
                <button onClick={() => handleDelete(item.keyword)} className="text-red-500 border-0">
