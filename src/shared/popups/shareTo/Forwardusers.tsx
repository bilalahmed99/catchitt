            ...
            <ClickAwayListener onClickAway={onClose}>
                <div className={style.parent} >
                    <div className={style.modalHeader} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '15px' }}>
                        <h1 className='text-black font-bold h5'>{t('Send to friends')}</h1>
                    ...
                    <div className={style.users}>
                        <p className='text-xs pb-2 text-[#16182380]'>{t("Recent")}</p>
                        ...
                        <div className='d-flex justify-between'>
                            <div className={style.messageInput}>
                                <textarea
                                    ...
                                    placeholder={t("Add a message to your video...")}
                                    rows={3}
                                />
