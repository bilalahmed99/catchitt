                            ...
                            <div className={`${style.inboxListItem}`}>
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        ...
                                        <p className="notificationContent">Follows you. 4h ago</p>
                                    </div>
                                </div>
                        ...
                        <div className={`${style.notificationList}`}>
                            <div className={`${style.inboxListItem}`}>
                                ...
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        <div className={`${style.notificationUsername}`}>Omarranjha</div>
                                        <div className="notificationContent">Follows you. 4h ago</div>
                                    </div>
                                </div>
                        ...
                        <div className={`${style.notificationList}`}>
                            <div className={`${style.inboxListItem}`}>
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        <div className={`${style.notificationUsername}`}>Omarranjha</div>
                                        <div className="notificationContent">mentioned you in a video 5-1</div>
                                    </div>
                                </div>
                        ...
                        <div className={`${style.notificationList}`}>
                            <div className={`${style.inboxListItem}`}>
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        <div className={`${style.notificationUsername}`}>Omarranjha</div>
                                        <div className="notificationContent">replied to your comment: 5-1</div>
                                        <div className={`${style.notificationReply}`}><span style={{ marginLeft: '10px' }}>Sudais Ranjha:</span> ❤️❤️❤️</div>
                                    </div>
                                </div>
                                <div className={`${style.mentionAvatar}`}>
                                    <img src={thumbnail} alt="Profile image" />
                        ...
                        <div className={`${style.notificationList}`}>
                            <div className={`${style.inboxListItem}`}>
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        <div className={`${style.notificationUsername}`}>Omarranjha</div>
                                        <div className="notificationContent">liked your video: 5-1</div>
                                    </div>
                                </div>
                                <div className={`${style.mentionAvatar}`}>
                                    <img src={thumbnail} alt="Profile image" />
                        ...
                        <div className={`${style.notificationList}`}>
                            <div className={`${style.inboxListItem}`}>
                                <div className={`${style.inboxListInner}`}>
                                    ...
                                    <div className={`${style.gridLine}`}>
                                        <div className={`${style.notificationUsername}`}>Long Name With All Details & Comments</div>
                                        <div className="notificationContent">liked your comment: 5-1</div>
                                        <div className={`${style.notificationReply}`}><span style={{ marginLeft: '10px' }}>Sudais Ranjha:</span> ❤️❤️❤️</div>
                                    </div>
                                </div>
                                <div className={`${style.mentionAvatar}`}>
